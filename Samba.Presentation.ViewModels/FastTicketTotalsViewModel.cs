...
namespace FastPay.Presentation.ViewModels
{
    [Export]
    public class FastTicketTotalsViewModel : ObservableObject
    {
        ...
        public FastTicketTotalsViewModel(ICacheService cacheService, AccountBalances accountBalances,
