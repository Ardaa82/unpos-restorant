...
{
    public class FastOrderTagButtonViewModel : ObservableObject
    {
        ...
        public FastOrderTagButtonViewModel(IEnumerable<Order> selectedOrders, OrderTagGroup tagGroup, OrderTag model)
        {
        ...
        public string Color
        {
            get
            {
                return _selectedOrders != null &&
                       _selectedOrders.All(x => x.IsTaggedWith(Model))
                           ? "Red"
                           : OrderTagGroup.ButtonColor ?? "Gainsboro";
            }
        }
