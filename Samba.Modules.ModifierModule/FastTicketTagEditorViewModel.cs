...
{
    [Export]
    public class FastTicketTagEditorViewModel : ObservableObject
    {
        ...
        public FastTicketTagEditorViewModel(IApplicationState applicationState, ICacheService cacheService, ITicketService ticketService)
        {
        ...
        public bool TicketTagSelected(Ticket currentTicket, TicketTagGroup tagGroup)
        {
            ...
            {
                ticketTags = _applicationState.GetTicketTagGroups()
                    .Where(x => x.Name == tagGroup.Name)
                    .SelectMany(x => x.TicketTags)
                    .ToList();
            }
