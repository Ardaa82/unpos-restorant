...
namespace Unpos.Modules.QuickSale
{
    ...
    public class MenuItemSelectorViewModel : ObservableObject
    {
            ...
            ISettingService settingService, ICacheService cacheService)
        {
            ...
            IncPageNumberCommand = new CaptionCommand<string>(Samba.Localization.Properties.Resources.NextPage + " >>", OnIncPageNumber, CanIncPageNumber);
            DecPageNumberCommand = new CaptionCommand<string>("<< " + Samba.Localization.Properties.Resources.PreviousPage, OnDecPageNumber, CanDecPageNumber);
            SubCategoryCommand = new CaptionCommand<ScreenSubCategoryButton>(".", OnSubCategoryCommand);
            CloseMenuViewCommand = new CaptionCommand<string>(Samba.Localization.Properties.Resources.Close, OnCloseMenuView);
