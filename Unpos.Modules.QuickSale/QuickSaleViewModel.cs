...
/* PosViewModel
 * Handles the main POS view model in the Samba POS system.
...
namespace Unpos.Modules.QuickSale
{
    ...
    public class QuickSaleViewModel : ObservableObject
    {
        ...
        public QuickSaleViewModel(IRegionManager regionManager, IApplicationState applicationState, IApplicationStateSetter applicationStateSetter,
        ...
        private void OnEntitySelectedForTicket(EventParameters<OperationRequest<Entity>> eventParameters)
        {
            ...
            {
                // Reset Fast Pay Mode on new entity selection
        ...
        private void OnTicketEvent(EventParameters<EventAggregator> obj)
        {
            switch (obj.Topic)
            {
                case EventTopicNames.CreateTicket:
                    ...
                    EventServiceFactory.EventService.PublishEvent(EventTopicNames.RefreshSelectedTicket);
                    break;
                case EventTopicNames.ActivateQuickSaleView:
        ...
        private void CloseTicket()
        {
            ...
            else
            {
                ...
                {   
                    ...
                    {   
                        if((_applicationState.IsFastPayMode && _applicationState.IsPaymentDone))
                        {
                            EventServiceFactory.EventService.PublishEvent(EventTopicNames.ActivateFastPayView);
                        }
                        else
                        {
                            EventServiceFactory.EventService.PublishEvent(EventTopicNames.TicketClosed);
                        }
