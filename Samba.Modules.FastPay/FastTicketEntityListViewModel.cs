...
{
    [Export]
    public class FastTicketEntityListViewModel : ObservableObject
    {
        ...
        public FastTicketEntityListViewModel(ICacheService cacheService)
        {
        ...
        {
            new OperationRequest<Entity>(obj, null).PublishEvent(EventTopicNames.FastEntitySelected, true);
        }
