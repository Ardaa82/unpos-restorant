...
{
    public class FastTicketButtonViewModel : ObservableObject
    {
        ...
        public FastTicketButtonViewModel(OpenTicketData openTicketData, Entity baseEntity)
        {
        ...
        {
            ExtensionMethods.PublishIdEvent(_openTicketData.Id, EventTopicNames.DisplayFastTicket);
        }
    }
}
