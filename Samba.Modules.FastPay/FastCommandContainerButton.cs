...
{
    public class FastCommandContainerButton : ObservableObject
    {
        private readonly AutomationCommandData _commandContainer;
        private readonly Ticket _selectedTicket;

        public FastCommandContainerButton(AutomationCommandData commandContainer, Ticket selectedTicket)
        {
