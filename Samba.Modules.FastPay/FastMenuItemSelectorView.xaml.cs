...
{
    [Export]
    public partial class FastMenuItemSelectorView : UserControl
    {
        ...
        private readonly FastMenuItemSelectorViewModel _viewModel;

        [ImportingConstructor]
        public FastMenuItemSelectorView(FastMenuItemSelectorViewModel viewModel)
        {
        ...
        {
            var sw = DataContext as FastMenuItemSelectorViewModel;
            if (sw == null) return;
