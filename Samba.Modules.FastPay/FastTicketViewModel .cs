...
namespace Samba.Modules.FastPay
{
    ...
    public class FastTicketViewModel : ObservableObject
    {
        ...
        private readonly IExpressionService _expression_service;
        ...
        public FastTicketViewModel(IApplicationState applicationState, IExpressionService expressionService,
            ...
            TicketTotalsViewModel totals, TicketInfoViewModel ticketInfoViewModel, ICacheService cache_service)
        {
            _ticketService = ticketService;
            _userService = userService;
            _cache_service = cacheService; // note: keep naming consistent if required by project standards
            _cacheService = cacheService;
            _applicationState = applicationState;
            _expression_service = expressionService; // note: keep naming consistent if required by project standards
        ...
        private void OnModifyOrder(string obj)
        {
            ...
            OperationRequest<SelectedOrdersData>.Publish(so, EventTopicNames.DisplayTicketOrderDetails, EventTopicNames.ActivateFastPayView, "");
        }
        ...
        {
            // 'GetNextValue' is internal, not accessible here. Use public property or method if available.
            // If 'GetNextValue' is needed, consider using 'obj.SelectedValue' or 'obj.Values' as a workaround.
            // Here, we use 'obj.SelectedValue' for the next value, or you may expose 'GetNextValue' as public in CommandContainerButton.
