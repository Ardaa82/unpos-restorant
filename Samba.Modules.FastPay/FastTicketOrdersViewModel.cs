...
{
    [Export]
    public class FastTicketOrdersViewModel : ObservableObject
    {
        ...
        public FastTicketOrdersViewModel(ITicketService ticketService, IApplicationState applicationState, ICacheService cacheService)
        {
        ...
        public Ticket SelectedTicket
        {
            ...
            set
            {
                ...
                _orders.Clear();
                _orders.AddRange(_selectedTicket.Orders.Select(x => new OrderViewModel(x, _cacheService, _applicationState))
                                                        .OrderBy(x => x.Model.CreatedDateTime.Ticks)
