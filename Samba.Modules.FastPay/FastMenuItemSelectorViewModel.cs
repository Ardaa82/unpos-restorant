...
{
    [Export]
    public class FastMenuItemSelectorViewModel : ObservableObject
    {
        ...
        public FastMenuItemSelectorViewModel(IApplicationState applicationState, IApplicationStateSetter applicationStateSetter,
